...
class HeaderLogo extends React.Component {
  ...
  render() {
    const { fullscreen,  windowHeight } = this.props;

    let keyNote = '';
    if (!fullscreen) {
      keyNote = <p className={styles.headerLogoKeynote}>Note: keyboard shortcuts are only available when the app is fullscreen.</p>;
    }
    ...
    return (
      <div>
        <button type="button" onClick={this.handleOpen} className={styles.headerLogo}>
          Trelliscope
