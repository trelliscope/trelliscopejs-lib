...
const HowToUse: React.FC = () => {
  ...
  return (
    <div className={styles.howToUse} style={{ maxHeight: Math.max(50, windowHeight - 310) }}>
      ...
      <div className={styles.howToUseP}>
        <i className={classNames('icon-th', styles.howToUseHi)} />
        &nbsp;
        <strong>Grid: </strong>
      ...
      <div className={styles.howToUseP}>
        <i className={classNames('icon-list-ul', styles.howToUseHi)} />
        &nbsp;
        <strong>Labels: </strong>
      ...
      <div className={styles.howToUseP}>
        <i className={classNames('icon-filter', styles.howToUseHi)} />
        &nbsp;
        <strong>Filter: </strong>
      ...
      <div className={styles.howToUseP}>
        <i className={classNames('icon-sort-amount-asc', styles.howToUseHi)} />
        &nbsp;
        <strong>Sort: </strong>
